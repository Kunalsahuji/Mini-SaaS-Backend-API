...
A **production-ready backend API** built with **Node.js, Express.js, and MongoDB**, designed using modern backend best practices.  
This project demonstrates **secure authentication**, **role-based authorization**, **subscription-based access control**, and **scalable architecture** suitable for real-world SaaS applications.
...
│   ├── modules/       # Feature-based modules (auth, user, subscription)
...
📌 **Note:** Add `logs/` to `.gitignore` to avoid committing runtime logs.
...
**Kunal Sahu**  
Full Stack Developer with hands-on experience in **JavaScript, Node.js, Express, MongoDB, React**, and modern backend architectures.  
Skilled in building **secure, scalable, and production-grade applications**, with internship experience in **.NET and Full Stack Development**.
